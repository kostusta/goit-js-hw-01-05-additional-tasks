console.log('** Module 1. Lesson 1. Переменные, типы и операторы**')
...
// // а в виде строк (специально для задачи). 
// // Нецелые числа могут быть заданы в виде 24.7 или 24,7, то есть в качестве разделителя 
...
// // присваивалось значение переменной incomingValue, если оно не равно undefined или null. 
// // В противном случае должно присваиваться значение defaultValue. 
// // Проверь работу скрипта для слепдующих значений переменной 
