console.log('** Module 1. Lesson 2. Ветвления. Циклы **')
...
// const userUnsver = prompt('Какое официальное название JavaScript?')
// const message = userUnsver === 'ECMAScript' ? 'Верно!' : 'Не знаете? ECMAScript!'
// console.log(message)
...
// // формата "14 ч. 26 мин.". Если значение переменной minutes равно 0, 
...
// // переменной link символом '/'. Если нет, добавь в конец значения link этот символ, 
